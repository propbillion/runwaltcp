// Google Ads Conversion Tracking - Runwal
document.addEventListener('click', function(e) {
  ...
  if (el && typeof gtag === 'function') {
   ...
   RUNWAL THE CENTRAL PARK - Production JS
...
(function () {
  ...
  if (form) {
    form.addEventListener('submit', (e) => {
      ...
      const message =
        'Hi%2C+I+want+Priority+Allocation+Access+for+RUNWAL+THE+CENTRAL+PARK+and+the+launch-phase+pricing.%0A%0A' +
  ...
  if (heroForm) {
    heroForm.addEventListener('submit', (e) => {
      ...
      const message =
        'Hi%2C+I+want+the+RUNWAL+THE+CENTRAL+PARK+launch+price+and+Priority+Allocation+Access.%0A%0A' +
        'Name%3A+' + encodeURIComponent(name) + '%0A' +
        'Mobile%3A+%2B91+' + encodeURIComponent(mob);
